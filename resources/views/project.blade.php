...
<body>
                ...
                <div class="turningButtonContainerInner">
                    ...
                    <div class="turnedButton">
                        <p>
                            ...
                            <button class="btn btn-light norms" data-toggle="modal" onClick="SetEditModal({{$submissionValues[$i]->id}})" data-target="#EditModal" data-toggle="tooltip" title="Add Submission">View Submission</button>
                            @php
                            $i++;
                            @endphp
    ...
    <div id="EditModal" class="modal modal-file" tabindex="-1" role="dialog" aria-hidden="true">
        <!-- Modal content -->
        <div class="modal-content modal-file-content">
            <form action="{{route('download_submission')}}" method="post" enctype="multipart/form-data">

                {{csrf_field()}}

                <div style="width:100.5%; height:40px; background-color:#C63E47;margin-left:-1px;">
                    <p class="text-center" style="color:#fff;font-size:25px;">download Submission</p>
                </div>
                ...
                <div class="row">
                    ...
                    <input type='submit' style="padding:5px; width: 75px;margin-left:60px;margin-top:25px;" class="btn btn-outline" value = "download submission">
    ...
    function SetEditModal(SubmissionValueId) {
        ...
        jQuery.ajax({
            ...
            success: function(result) {
                ...
                $("#originalName").val(result[0]['OriginalName']);
